...
class m240410_104632_rights_ruleDataInsert extends Migration
{
    ...
    {
        $this->batchInsert('{{%rights_rule}}',
                           ["name", "data", "created_at", "created_uid", "updated_at", "updated_uid"],
                            [
    [
        'name' => 'checkAll',
    ...
    {
        //$this->truncateTable('{{%rights_rule}} CASCADE');
    }
}
