...
<p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; text-align: justify">
    <?= Yii::t('emails', "Уважаемый {userName}! Регистрация успешно завершена. Однако, Вы cможете авторизоваться " .
        "используя логин и пароль, который был указан при регистрации только после подтверждения корректности Email адреса. " .
        "Для подтверждения Email, нажмите кнопку внизу письма. <br />Помните, что по умолчанию, Вам доступны стандартные права доступа. " .
