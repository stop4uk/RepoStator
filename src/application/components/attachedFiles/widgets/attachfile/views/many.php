 ...
 * @var bool $loadInSession Необходимость грузить файлы в сессию, без привязки к БД
 * @var bool $showAllFiles Возможность выключать отображение всего списка загруженных файлов для модели
 * @var string $pjaxIDContainer
 */
        ...
        <div class="card-body">
                        ...
                        <div class="dropdown-menu">
                            <?php foreach ($canAttached as $type => $params) {
                                ...
                                echo FileUploadWidget::widget([
                                    ...
                                    'options' => [
                                        'id' => 'fileUpWidget_' . $pjaxIDContainer . '_' . $type,
                                    ],
                                    'clientOptions' => [
                                        'maxFileSize' => 2000000,
                                    ],
                                    'clientEvents' => [
                                        'fileuploaddone' => 'function(e, data) {
                                            ...
                                            if (response.status == "success") {
                                                $.pjax.reload({container:"#' . $pjaxIDContainer . '"});
                                            } else {
            ...
            <?php
                ...
                if ($loadInSession) {
                    ...
                    $dataProviderSession = new ArrayDataProvider([
                    ...
                    if ($dataProviderSession->getTotalCount()) {
                ...
                if ($showAllFiles) {
                    $dataProvider = $parentModel->getAttachedFiles();
