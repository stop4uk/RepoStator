...
use app\repositories\group\{repositories\group\GroupRepository, repositories\group\GroupTypeRepository};
use helpers\group\GroupHelper;
use yii\base\Model;
...
final class GroupSearch extends Model
{
    ...
    {
        $this->types = \repositories\group\GroupTypeRepository::getAll(
            asArray: true
        );

        $this->groups = \repositories\group\GroupRepository::getAll(
            asArray: true
        );
    ...
    {
        $query = \repositories\group\GroupRepository::getAllBy(
