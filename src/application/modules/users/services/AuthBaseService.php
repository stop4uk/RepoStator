...
use entities\user\UserEmailchangeEntity;
use forms\auth\{RegisterForm};
use forms\auth\LoginForm;
use forms\auth\RecoveryForm;
use forms\auth\VerificationForm;
 ...
 */
final class AuthBaseService extends Component implements BaseServiceInterface
{
