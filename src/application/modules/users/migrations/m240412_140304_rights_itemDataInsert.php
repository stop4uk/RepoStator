...
class m240412_140304_rights_itemDataInsert extends Migration
{
    ...
    {
        $this->batchInsert('{{%rights_item}}',
                           ["name", "type", "description", "rule_name", "data", "created_at", "created_uid", "updated_at", "updated_uid"],
                            [
    [
        'name' => 'admin',
        'type' => '1',
    ...
    {
        //$this->truncateTable('{{%rights_item}} CASCADE');
    }
}
