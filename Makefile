...
build: ## Build environment
	@HOST_UID=$(HOST_UID) HOST_GID=$(HOST_GID) WEB_PORT_HTTP=$(WEB_PORT_HTTP) WEB_PORT_HTTPS=$(WEB_PORT_HTTPS) DB_PORT=$(DB_PORT) DB_NAME=$(DB_NAME) DB_PASS=$(DB_PASS) docker compose -f docker-compose.yml build --no-cache
